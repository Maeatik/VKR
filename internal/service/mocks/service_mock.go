...
func (m *MockService) ChangePassword(ctx context.Context, id int, password, newPassword string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChangePassword", ctx, id, password, newPassword)
	ret0, _ := ret[0].(error)
	return ret0
}

// ChangePassword indicates an expected call of ChangePassword.
func (mr *MockServiceMockRecorder) ChangePassword(ctx, id, password, newPassword interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChangePassword", reflect.TypeOf((*MockService)(nil).ChangePassword), ctx, id, password, newPassword)
}
...
func (m *MockService) DeleteUsers(ctx context.Context, id int, password string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUsers", ctx, id, password)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteUsers indicates an expected call of DeleteUsers.
func (mr *MockServiceMockRecorder) DeleteUsers(ctx, id, password interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUsers", reflect.TypeOf((*MockService)(nil).DeleteUsers), ctx, id, password)
}
...
func (m *MockService) PostMainText(ctx context.Context, userID, siteID int, text string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PostMainText", ctx, userID, siteID, text)
	ret0, _ := ret[0].(error)
	return ret0
}

// PostMainText indicates an expected call of PostMainText.
func (mr *MockServiceMockRecorder) PostMainText(ctx, userID, siteID, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PostMainText", reflect.TypeOf((*MockService)(nil).PostMainText), ctx, userID, siteID, text)
}
...
func (m *MockService) UpdateMainText(ctx context.Context, userID, id, siteID int, text string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateMainText", ctx, userID, id, siteID, text)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateMainText indicates an expected call of UpdateMainText.
func (mr *MockServiceMockRecorder) UpdateMainText(ctx, userID, id, siteID, text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateMainText", reflect.TypeOf((*MockService)(nil).UpdateMainText), ctx, userID, id, siteID, text)
}
